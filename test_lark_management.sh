...
# 1. 检查初始状态（应该未运行）
echo "1. 检查初始状态..."
uv run python3 agent_remote.py lark status
echo ""

# 2. 启动飞书客户端
echo "2. 启动飞书客户端..."
uv run python3 agent_remote.py lark start
echo ""
...
uv run python3 agent_remote.py lark start || true
echo ""
...
# 8. 重启
echo "8. 重启飞书客户端..."
uv run python3 agent_remote.py lark restart
echo ""
...
# 11. 停止
echo "11. 停止飞书客户端..."
uv run python3 agent_remote.py lark stop
echo ""
